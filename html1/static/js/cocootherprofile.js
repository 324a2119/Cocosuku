...
// mock data (デモ用 — 実運用では API から取得してください)
const mockProfiles = {
  "そら": {
    name:"そら",
...
const userProfile = mockProfiles[userName] || { name: userName || "不明なユーザー", bio: "", avatar: "？", details: {
  hobby: "未設定", circle: "未設定", dept: "未設定", year: "未設定", license: "未設定", comment: ""
} };

// 自分のプロフィールページへリダイレクト（必要なら有効化）
